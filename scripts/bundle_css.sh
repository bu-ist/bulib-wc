...
sass ./src/header/header.scss > ./src/header/header.css;
sass ./src/header/mobile-nav.scss >> ./src/header/header.css;
sass ./src/header/banner.scss >> ./src/header/header.css;
