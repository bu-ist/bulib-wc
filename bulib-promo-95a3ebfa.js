import{h as o}from"./lit-html-2435d3b6.js";import{L as t,c as r}from"./lit-element-fdaadb84.js";const i=o`<h3>'<code>top</code>': this is where you might just put a heading</h3>`,e=o`
  <div>
...
`;window.customElements.define("bulib-promo",class extends t{static get properties(){return{debug:{type:Boolean}}}static get styles(){return[r`
        div.promo { 
      ...
      <div class="promo">
        ...
        <div class="bottom">
          <slot name="bottom">${e}</slot>
        </div>
      </div>
    `}updated(){this._hideHeadingsIfTheyAreNotSpecified(),this._setMainBackgroundViaSlottedImage()}_setMainBackgroundViaSlottedImage(){let o="",t=this.querySelector("img[slot='main'");try{t&&t.hasAttribute("src")&&(o=t.src),this.shadowRoot.querySelector("div.promo div.main").style.backgroundImage=`url('${o}')`,t.hasAttribute("height")&&(this.shadowRoot.querySelector("div.promo div.main").style.height=t.getAttribute("height"))}catch(o){this.debug&&console.log("bulib-promo) error - no readable image_elem (img[slot='main'])")}}_hideHeadingsIfTheyAreNotSpecified(){this.debug||null!=this.querySelector("*[slot='top']")||(this.shadowRoot.querySelector("div.top").style.display="none"),this.debug||null!=this.querySelector("*[slot='bottom']")||(this.shadowRoot.querySelector("div.bottom").style.display="none")}});
//# sourceMappingURL=bulib-promo-95a3ebfa.js.map
